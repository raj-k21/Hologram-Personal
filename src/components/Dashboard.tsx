  ...
  return (
    <div id="central-hud-dashboard" className="w-full h-full bg-black flex flex-col justify-between p-6 overflow-y-auto select-none">
      ...
      <div className="flex items-center justify-between border-b border-white/5 pb-4">
        ...
        <div className="flex items-center gap-5 text-[9px] font-mono text-white/45">
      ...
      <div className="flex-1 grid grid-cols-3 gap-6 py-6 items-stretch">
        
        {/* Card 1: Neon LED Clock */}
        <div
          id="btn-card-clock"
          onClick={() => onModeChange('clock')}
          className="group relative border border-white/10 hover:border-red-500/50 bg-white/[0.01] hover:bg-red-950/5 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 cursor-pointer shadow-[0_0_15px_rgba(255,255,255,0.01)] hover:shadow-[0_0_20px_rgba(239,68,68,0.15)] overflow-hidden"
        >
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono text-white/35 tracking-widest">PROJECTION MODE 01</span>
            <Clock className="w-5 h-5 text-red-500 group-hover:scale-110 transition-all" />
          </div>

          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-red-500 uppercase tracking-widest leading-snug">
              HOLOGRAM CLOCK
            </h2>
            <p className="text-xs text-white/50 font-mono mt-1 leading-snug">
          ...
          <div className="flex items-center justify-between border-t border-white/5 pt-3 mt-2 text-[9px] font-mono text-red-400/70 font-bold uppercase tracking-widest">
        ...
        <div
          ...
          className="group relative border border-white/10 hover:border-cyan-500/50 bg-white/[0.01] hover:bg-cyan-950/5 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 cursor-pointer shadow-[0_0_15px_rgba(255,255,255,0.01)] hover:shadow-[0_0_20px_rgba(34,211,238,0.15)] overflow-hidden"
        >
          {/* Neon accent corner glow */}
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono text-white/35 tracking-widest">PROJECTION MODE 02</span>
            <TrendingUp className="w-5 h-5 text-cyan-400 group-hover:scale-110 transition-all" />
          </div>

          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-cyan-400 uppercase tracking-widest leading-snug">
              LIVE STOCK INDEXES
            </h2>
            <p className="text-xs text-white/50 font-mono mt-1 leading-snug">
          ...
          <div className="flex items-center justify-between border-t border-white/5 pt-3 mt-2 text-[9px] font-mono text-cyan-400/70 font-bold uppercase tracking-widest">
        ...
        <div
          ...
          className="group relative border border-white/10 hover:border-indigo-500/50 bg-white/[0.01] hover:bg-indigo-950/5 rounded-2xl p-6 flex flex-col justify-between transition-all duration-300 cursor-pointer shadow-[0_0_15px_rgba(255,255,255,0.01)] hover:shadow-[0_0_20px_rgba(168,85,247,0.15)] overflow-hidden"
        >
          {/* Neon accent corner glow */}
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono text-white/35 tracking-widest">PROJECTION MODE 03</span>
            <Compass className="w-5 h-5 text-indigo-400 group-hover:scale-110 transition-all" />
          </div>

          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-indigo-400 uppercase tracking-widest leading-snug">
              INFINITE VISUALS
            </h2>
            <p className="text-xs text-white/50 font-mono mt-1 leading-snug">
          ...
          <div className="flex items-center justify-between border-t border-white/5 pt-3 mt-2 text-[9px] font-mono text-indigo-400/80 font-bold uppercase tracking-widest">
      ...
      <div className="border-t border-white/5 pt-4 flex flex-row items-center justify-between gap-4">
        
        {/* Dynamic code logs */}
        <div className="flex items-center gap-4 text-[9px] font-mono text-white/20">
          <div>FEED VECTOR LOG:</div>
          {digitalRain.map((str, idx) => (
            <div key={idx} className="block select-none animate-pulse">
              {str}
            </div>
          ))}
        </div>
