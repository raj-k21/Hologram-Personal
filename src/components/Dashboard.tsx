...
export default function Dashboard({
  ...
  return (
    <div id="central-hud-dashboard" className="w-full h-full bg-black flex flex-col justify-between p-6 overflow-y-auto select-none">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 py-6 items-stretch">
        ...
        >
          ...
          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-red-500 uppercase tracking-widest">
              HOLOGRAM CLOCK
            </h2>
        ...
        >
          ...
          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-cyan-400 uppercase tracking-widest">
              LIVE STOCK INDEXES
            </h2>
            <p className="text-xs text-white/50 font-mono mt-1 leading-snug">
        ...
        >
          ...
          <div className="my-4">
            <h2 className="text-xl font-mono font-black text-indigo-400 uppercase tracking-widest">
              INFINITE VISUALS
            </h2>
            <p className="text-xs text-white/50 font-mono mt-1 leading-snug">
